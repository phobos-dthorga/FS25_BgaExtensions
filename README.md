...
The current implementation provides PlanET-compatible biomass intake modules, a Wet Substrate Prep module, and scaled dry fuel yards. The intake modules convert forage, manure, straw, and pellet routes into the internal feedstocks used by `FS25_PlanET_BGA_Modular`; Wet Substrate Prep handles wet/root/produce crops before handing them to PlanET as beet-cut substrate; and the dry fuel yards store `WOODCHIPS` and `STRAW_PELLETS` for heat-plant logistics.
