...
| Emergency only | Poplar and woody biomass | `POPLAR`, `WOODCHIPS` | Combustion fuel or pretreatment-only biomass route | 0.05-0.20 | Better suited to heating than BGA. Store wood chips in the dry fuel yard, not in the BGA intake. |
