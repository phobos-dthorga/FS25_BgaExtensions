...
For the self-contained helper pass, smoke-test the Lua helper paths:

- confirm core `FS25_BgaExtensions` loads without the retired helper package installed
...
- run log triage and confirm no GBW-owned warnings/errors are introduced
